...
- **Brand Wellness** (read-only milestone-history report + Reggie-drawer
  CTA) SHIPPED + pushed 2026-07-07. DC-internal, no contract surface — no
  §3/§6 entry (consistent with 005.1 / 010 handling); full detail in DC
  CLAUDE.md §16. 005.2 is now the next open DC batch.
