...
NEXT (resequenced 2026-07-15 with Lacey — Batch 012 Client Library
  ...
  1  012     Client Library (cross-brand experimentation; Phase A = MVP)
  2  008     Convert.com integration   (consumes 012 Phase B ingest; discovery-first)
...
Batch 005.2, Batch 005.3, Batch 005.4, Batch 005.5. DISSOLVED: Batch 010.2
