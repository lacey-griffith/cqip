...
```
NEXT (locked 2026-07-09; 005.4 + 005.5 SHIPPED 2026-07-09,
      admin filter-by-brand shipped as the 005.5 ride-along)
  1  006     Teams dispatch (expanded)            ← unblocks 010.1 live pings
  2  010.1   Pipeline alerts (merged 010.2 + Path 2)   — PM consult owed
  3  007     Custom Jira Boards
  4  —       Per-brand config pages               (prereq for 008)
  5  008     Convert.com integration              (discovery-first)
