...
1. Awaiting-Client-Input tag treatment in the merged view — **RESOLVED by
   the locked chip set below** (it's one of the four HOLD chips; renders as
   an accordion-row pipeline-hold chip).
