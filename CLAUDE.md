...
deferred:** rework overlay (milestones vs sendbacks on one axis),
export/share, multi-brand compare, and the optional per-dot "unresolved —
not counted" timeline badge (Karen's suggestion) are NOT in v1 (TODO
comments in the component mark the first three). Note: Batch 005.2
